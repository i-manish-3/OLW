...
<div class="row">
<div class="col-lg-12"> 
<h1 class="page-header">List of Users <small>|  <label class="label label-xs" style="font-size: 14px"><a href="index.php?view=add">  <i class="fa fa-plus-circle fw-fa"></i> New</a></label> |</small></h1> 

</div>
<!-- /.col-lg-12 -->
</div>
<form action="controller.php?action=delete" Method="POST">  					
<table id="example" class="table table-hover table-bordered" cellspacing="0" style="font-size:14px" >
